 export  function matchingProductfun (productId){
  let matchingProduct;
  ...
  getUrlMethod(){
     ...
     return `images/ratings/rating-${this.rating.stars * 10}.png alt="rating"`
  }
  addsizechartLink(){
    return ` `
  }
   ...
   export class clothing extends productclass{
    sizeChartLink;
    ...
    addsizechartLink(){
      return `<a href="images/clothing-size-chart.png">sizechartLink</a>`
    }
...
export  function loadProducts(fun){
 ...
 const productr=new productclass({
